...
iqthon_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "╮•• مـعلومات الـشخص من بوت سـبارك "
...
async def fetch_info(replied_user, event):
    ...
    rotbat = "⌁ من مطورين السورس 𓄂𓆃 ⌁" if user_id == 5012406813 else ("⌁ العضـو 𓅫 ⌁")
    rotbat = "⌁ مـالك الحساب 𓀫 ⌁" if user_id == (await event.client.get_me()).id and user_id != 5012406813  else rotbat
