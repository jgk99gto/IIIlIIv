...
IQTHONPC = gvarstatus("ALIVE_PIC") or "https://graph.org/file/c2f13a769faefb737bd5c.mp4"
...
IQPIC = gvarstatus("ALIVE_PIC") or "https://graph.org/file/c2f13a769faefb737bd5c.mp4"
...
async def iq(iqthonevent):
    ...
    IQTHON_IMG = gvarstatus("ALIVE_PIC") or "https://graph.org/file/c2f13a769faefb737bd5c.mp4"
...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ سورس سـبـارك - Telethon-Arabe ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"🝳︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس سبارك @ZZZ7iZ :**\n\n{o}")
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , """🝳︙ جـاري تـحديث سورس سـبـارك (7.7)
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**🝳︙  📑 يرجى متابع قناه الفارات تجدها هنا : @A_H_fo")
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlineiqthon(iqthon):
        ...
        if query.startswith("تنصيب") and iqthon.query.user_id == bot.uid:
            buttons = [[Button.url("1- قناة السورس", "https://t.me/ZZZ7iZ"), Button.url("2- استخراج ايبيات", "https://my.telegram.org/"),],[Button.url("3- ستخراج تيرمكس", "https://t.me/trn1bot"), Button.url("4- بوت فاذر", "http://t.me/BotFather"),],[Button.url("5- رابط التنصيب", "https://dashboard.heroku.com/new?template=https://github.com/jgk99gto/SBERK"),],[Button.url("المطـور 👨🏼‍💻", "https://t.me/IIIlIIv"),]]
...
✐ :  يعطيك رموز للزخرفه2 
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : @A_H_fo
""")
...
@check_owner
async def inlineiqthon(iqthon):
    text = "**🝳︙ قـائمـه الاوامـر :**\n**🝳︙ قنـاه السـورس :** @ZZZ7iZ\n**🝳︙ شـرح اوامـر السـورس : @A_H_fo**\n**🝳︙ مطور السـورس : @IIIlIIv** "
...
async def iq(event):
    await edit_or_reply(event, "**صاحب الهمسه يكول  **\n**انت وين لكيت هاي الكلاوات 😂**")
